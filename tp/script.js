...
function getUsers() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, axios.get('https://jsonplaceholder.typicode.com/users')];
                case 1:
                    response = _a.sent();
...
function getPosts() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, axios.get('https://jsonplaceholder.typicode.com/posts')];
                case 1:
                    response = _a.sent();
                    return [2, response.data];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4, Promise.all([getUsers(), getPosts()])];
                case 1:
